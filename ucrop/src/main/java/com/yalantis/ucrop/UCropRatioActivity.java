...
public class UCropRatioActivity extends AppCompatActivity {
...
//    private List<ViewGroup> mCropAspectRatioViews = new ArrayList<>();
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mCompressQuality = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_QUALITY, UCropRatioActivity.DEFAULT_COMPRESS_QUALITY);
...
//            mGestureCropImageView.setTargetAspectRatio(CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        if (mShowBottomControls) {
            ...
            LayoutInflater.from(this).inflate(R.layout.ucrop_controls2, wrapper, true);
...
//        }
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.ucrop_aspect_ratio2, mLayoutAspectRatio, false);
        ...
        mRadiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Log.d("yeqing","checkedId:"+position);
                mGestureCropImageView.setTargetAspectRatio(
                        aspectRatioList.get(position).getRatio());
                mGestureCropImageView.setImageToWrapCropBounds();
            }
        });

        mLayoutAspectRatio.addView(view);
    }
